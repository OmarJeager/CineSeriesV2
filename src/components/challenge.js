    ...
    const fetchQuestions = (selectedCategory) => {
        switch (selectedCategory) {
            ...
            case "people":
                ...
                break;
            case "tvshows":
                setQuestions(tvShowsQuestions);
                break;
            case "oscars":
                setQuestions(oscarQuestions);
                break;
            case "anime":
        ...
        <div className="quiz-container">
            {!category ? (
                <div className="category-selection">
                    ...
                    <button onClick={() => handleCategorySelect("tvshows")}>TV Shows</button>
                    <button onClick={() => handleCategorySelect("oscars")}>Oscars</button>
